...
E(f"{jp}.jomon", "era", "Jōmon Period", jp,
  ...
  native_name="縄文時代",
  summary="Hunter-gatherer culture famous for cord-marked pottery.")
...
E("oceania.melanesia.lapita", "era", "Lapita Culture", "oceania.melanesia", start=-1500, end=500, tier="intermediate",
  summary="Ancestral Austronesian seafarers whose descendants settled most of Remote Oceania.")
...
E("oceania.polynesia.settlement", "era", "Polynesian Voyaging & Settlement", "oceania.polynesia",
  start=-1000, end=1300, tier="foundational",
  summary="Austronesian seafarers reached Tonga, Samoa, Hawaii, Aotearoa, and Rapa Nui by 1300 CE.")
